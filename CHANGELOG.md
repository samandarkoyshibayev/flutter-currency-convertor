...
Ushbu loyihadagi barcha muhim o'zgarishlar ushbu faylda qayd etib boriladi.
Format [Keep a Changelog](https://keepachangelog.com/en/1.1.0/) standartiga asoslangan,
va ushbu loyiha [Semantic Versioning](https://semver.org/spec/v2.0.0.html) qoidalariga amal qiladi.

## [Unreleased]
*Hali e'lon qilinmagan o'zgarishlar.*
